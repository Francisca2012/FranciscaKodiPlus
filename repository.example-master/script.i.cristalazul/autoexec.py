...
def main():
	class enableAll():
		def __init__(self):
			...
			if not os.path.exists(os.path.join(self.databasepath, self.dbfilename)):
				xbmc.sleep(2000)
				xbmcgui.Dialog().notification("Instalador [COLOR aqua]CRISTAL AZUL[/COLOR]", "No Addons27.db file")
	...
	try:
		xbmcgui.Dialog().notification("Instalador [COLOR aqua]CRISTAL AZUL[/COLOR]", "Activando addons...")
		firstRun = enableAll()
		xbmcgui.Dialog().notification("Instalador [COLOR aqua]CRISTAL AZUL[/COLOR]", "Todos los addons activados")
		xbmcvfs.delete('special://userdata/autoexec.py')
	except Exception, e:
		xbmcgui.Dialog().notification("Instalador [COLOR aqua]CRISTAL AZUL[/COLOR]", "Error Check LogFile")
